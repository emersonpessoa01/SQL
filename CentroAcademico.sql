...
cpf,nome,data_nascimento,titulacao,telefone
)
values('99999999999','emerson','2020-12-18','professor','(91)98999-9988'),
('99999999998','mario','2021-12-18','aluno','(91)98999-9987');

-- Criação de Coluna
ALTER TABLE Professores
ADD column formacao varchar(20) NOT NULL;

-- Visualiza a Tabela
DESC Professores;

-- Visualiza a todas as tabela de um banco
SHOW TABLES;

-- Visualiza a tabela em específico de um banco 
